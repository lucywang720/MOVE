...
class MetaWorldEnv(gym.Env):
    ...
    def __init__(self, task_name, device="cuda:0", 
                 use_point_crop=True,
                 num_points=1024, random_init=False
                 ):
        ...
        self.env.random_init = random_init
    ...
    def step(self, action: np.array):
        ...
        # if isinstance(self.env, SawyerPickPlaceEnvV2):
        #     print(type(self.env))
        #     print(vars(self.env))
        # if self.cur_step != 0 and self.cur_step % 20 == 0:
